...
//----------------------------------------------------------------------
//----------------------------------------------------------------------
//	The first user task function: it is automatically called at startup after the creation of the first task.
//	The configuration of the 1st task is in aacfg.h
