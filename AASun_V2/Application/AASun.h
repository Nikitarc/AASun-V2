...
#define		IX_I1		1
  ...
  #if (I_SENSOR_COUNT >= 3)
	  #define	IX_I3		3
	  #define	IX_BATTV	4		// Battery voltage
  #else
	  #define	IX_BATTV	3		// Battery voltage
  #endif
#else
  #define	IX_BATTV	2		// Battery voltage
#endif
#define		IX_IPOWER	1		// The current sensor to use to compute the main real power

// Count of used ADC channels: 1 for volt, 1 to 3 for current, 1 for battery volt
#define	ADC_CHANCOUNT		(I_SENSOR_COUNT + 2)

// Define the timer to use as ADC trigger
#define	TIMSYNC				TIM3
...
// Define the timer to use as SSR PWM outputs
#define	TIMSSR				TIM1
...
#define	TIMSSR_CLK_HZ		51200u					// The timer clock in Hz. 51200 Hz is 512 clock in 10ms.
